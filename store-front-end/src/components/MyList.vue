    ...
    <ul>
      <li v-for="item in list" :key="item.product_id">
        ...
        <router-link :to="{ path: '/goods/details', query: {productID:item.product_id} }">
          <img :src="item.product_picture.includes('http:')?item.product_picture:'https://6156-pictures.s3.amazonaws.com/' + item.product_picture" alt />
...
export default {
  ...
  methods: {
    deleteCollect(product_id) {
      this.$axios
        .post("https://keimui43t1.execute-api.us-east-1.amazonaws.com/collect/remove", {
