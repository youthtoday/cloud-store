  ...
  <div id="details">
    ...
    <div class="main">
      ...
      <div class="content">
        ...
        <p class="store">official store</p>
        <div class="price">
        ...
        <div class="pro-list">
          ...
          <p class="price-sum">overall : ${{productDetails.product_selling_price}}</p>
        </div>
        <!-- 内容区底部按钮 -->
        <div class="button">
        ...
        <div class="pro-policy">
          <ul>
            <li>
              <i class="el-icon-circle-check"></i> Official Store
            </li>
            <li>
              <i class="el-icon-circle-check"></i> Official Shipment
            </li>
            <li>
              <i class="el-icon-circle-check"></i> 30 Days Free Return
            </li>
            <li>
              <i class="el-icon-circle-check"></i> 7 Days Price Guarantee
            </li>
          </ul>
        </div>
      </div>
